...
NotifyLib.prompt('Loaded!', 'Modified & Created By:.LunarWare ', 5) 
...
NotifyLib.prompt('Mobile Device Detected', 'Loading LunarWare tool..', 5) 
...
NotifyLib.prompt('Mobile FN', 'LunarWare Has Successfully Loaded!', 5) 
...
NotifyLib.prompt('Hybird Mobile Device Detected', 'Loading LunarWare Tool..', 5) 
